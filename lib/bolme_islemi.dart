...
class BolmeIslemiSayfasi extends StatefulWidget {
  @override
  _BolmeIslemiSayfasiState createState() => _BolmeIslemiSayfasiState();
}

class _BolmeIslemiSayfasiState extends State<BolmeIslemiSayfasi> {
  static var  sayi = new Random();
  static var sayi1 = sayi.nextInt(100);
  static var sayi2 = sayi.nextInt(10);
  static var bolme = sayi1 / sayi2;

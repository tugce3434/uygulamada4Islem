...
class CikarmaIslemiSayfasi extends StatefulWidget {
  @override
  _CikarmaIslemiSayfasiState createState() => _CikarmaIslemiSayfasiState();
}

class _CikarmaIslemiSayfasiState extends State<CikarmaIslemiSayfasi> {
  static var  sayi = new Random();
  static var sayi1 = sayi.nextInt(100);
  static var sayi2 = sayi.nextInt(100);
  static var fark = sayi1 - sayi2;

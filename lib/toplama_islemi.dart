...
import 'package:medium_navigasyon/form_islemleri.dart';

class ToplamaIslemiSayfasi extends StatefulWidget {
  @override
  _ToplamaIslemiSayfasiState createState() => _ToplamaIslemiSayfasiState();
}

class _ToplamaIslemiSayfasiState extends State<ToplamaIslemiSayfasi> {
  static var  sayi = new Random();
  static var sayi1 = sayi.nextInt(100);
  static var sayi2 = sayi.nextInt(100);
  static var toplam = sayi2 + sayi1;
